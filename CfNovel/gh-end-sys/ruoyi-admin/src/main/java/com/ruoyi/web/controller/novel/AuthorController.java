...
public class AuthorController extends BaseController
{
     ...
     * 查询作者列表
     */
    @PreAuthorize("@ss.hasPermi('novel:author:list')")
    @GetMapping("/list")
     ...
     * 导出作者列表
     */
    @PreAuthorize("@ss.hasPermi('novel:author:export')")
     ...
     * 获取作者详细信息
     */
    @PreAuthorize("@ss.hasPermi('novel:author:query')")
    @GetMapping(value = "/{id}")
    public AjaxResult getInfo(@PathVariable("id") Long id)
    {
        return AjaxResult.success(authorService.selectAuthorById(id));
    }

    /**
     * 新增作者
     */
    @PreAuthorize("@ss.hasPermi('novel:author:add')")
     ...
     * 修改作者
     */
    @PreAuthorize("@ss.hasPermi('novel:author:edit')")
     ...
     * 删除作者
     */
    @PreAuthorize("@ss.hasPermi('novel:author:remove')")
